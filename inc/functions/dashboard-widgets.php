<?php
  ...
  function custom_dashboard_live_class(){
    ...
    echo '<a href="'.$site_url1.'/wp-admin/edit.php?s&post_status=all&post_type=product&action=-1&filter_class_city&filter_class_status=Live&filter_attendee_id&product_cat&filter_action=Filter&paged=1&action2=-1">Manage</a>';
  }
  //Course Widget
  ...
  function custom_dashboard_cancelled_class(){
    ...
    echo '<a href="'.$site_url1.'/wp-admin/edit.php?s&post_status=all&post_type=product&action=-1&filter_class_city&filter_class_status=Cancel&filter_attendee_id&product_cat&filter_action=Filter&paged=1&action2=-1">Manage</a>';
  }
