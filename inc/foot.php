	...
	<script>(function(d){var s=d.createElement("script");s.setAttribute("data-account","3lQRk6gIfu");s.setAttribute("src","https://cdn.userway.org/widget.js");(d.body || d.head).appendChild(s);})(document)</script><noscript>Please ensure Javascript is enabled for purposes of <a href="https://userway.org">website accessibility</a></noscript>

<script type="application/javascript">
    jQuery(window).on('load', function() {
        jQuery(".grecaptcha-badge").parent('div').addClass('grecaptcha-badge-parent');
        jQuery("#wrapper ~ div").css("display", "none");
        jQuery("#wpadminbar, .grecaptcha-badge-parent").css("display", "block");
    });
</script>
