              ...
              <div class="row mb-3">
              	<div class="col-md-6 mb-4 mb-md-0">
              		...
              		<form>
                        ...
                        <?php 
                          $class_citystate = $venuestate.' - '.$venuecity; 
                          ...
                          foreach($venues_terms as $venues_term){
                            ...
                            if($venueclassfound > 0){
                              $classstatecity = $venuestate.' - '.$venuecity; ?>
                              <option <?php if($class_citystate == $classstatecity){echo 'selected="selected"';} ?> value="<?php echo $venuestate; ?> - <?php echo $venuecity; ?>"><?php echo $venuestate; ?> - <?php echo $venuecity; ?></option>
                            <?php }
                          }
                        ?>
    				          </select>
                  ...
                  if( $the_query2->have_posts() ):
                    while( $the_query2->have_posts() ) : $the_query2->the_post(); 
                      ...
                      $cancel_status = get_field('class_status',$product_id);
                        ...
                        <tr role="row">
                  				<td class="sorting_1" title="Date"><i class="d-none"><?php echo date("mdY", strtotime($class_date1)); ?></i> <?php echo $class_date; if($class_days > 1){echo '-<br>'.$nextday;} ?></td>
